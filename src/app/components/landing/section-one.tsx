                ...
                <div className="col-xl-7 mt-high" style={{ ["paddingInline" as any]: "2rem" }}>
                    ...
                    (
                        <div className="mt-5" key={index}>
                            <h3 className="monserrat-bold text-large text-uppercase fade-effect"
                                dangerouslySetInnerHTML={{
                                    __html: typeof item.title === 'string'
                                        ? item.title
                                        : ""
                                }}
                                fade-time="2" fade-direction="left"></h3>
                            <p className="text-d4 text-medium fauna-one w-90 mt-4 fade-effect"
                                dangerouslySetInnerHTML={{
                                    __html: typeof item.description === 'string'
                                        ? item.description
                                        : ""
                                }} fade-time="2" fade-direction="left">
                            </p>
                        </div>
                    )
